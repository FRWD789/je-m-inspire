                ...
                <table role="presentation" class="email-container" cellspacing="0" cellpadding="0" border="0" align="center" width="600">
                    ...
                    <tr>
                        <td class="email-header">
                            <img src="{{ $logoUrl ?? {{ env('FRONTEND_URL') }} . '/assets/img/logo-white.png' }}" alt="{{ config('app.name') }}" class="logo">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="email-footer">
                            ...
                            <p class="footer-text">
                                Des questions ? <a href="{{ env('FRONTEND_URL') }}/contact" class="footer-link">Contactez-nous</a>
                            </p>
